...
public class SecurityUtilsTest {
  ...
  @DisplayName("DES 加密性能测试")
  @Test
  void des() throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException, InvalidCipherTextException, InvalidKeySpecException {
