...
public class ToListTest {
  ...
  @Benchmark
  public List<ToJsonTest.TestBean> jackson() throws JsonProcessingException {
    return new ArrayList<>(Arrays.asList(objectMapper.readValue(JSON_STR, ToJsonTest.TestBean[].class)));
  }

  @Benchmark
  public List<ToJsonTest.TestBean> fastjson() {
    return JSON.parseArray(JSON_STR, ToJsonTest.TestBean.class);
  }

  private final static Gson gson = new Gson();

  @Benchmark
  public List<ToJsonTest.TestBean> gson() {
    return new ArrayList<>(Arrays.asList(gson.fromJson(JSON_STR, ToJsonTest.TestBean[].class)));
  }

  @Benchmark
  public List<ToJsonTest.TestBean> hutool() {
    return JSONUtil.toList(JSON_STR, ToJsonTest.TestBean.class);
  }
}
